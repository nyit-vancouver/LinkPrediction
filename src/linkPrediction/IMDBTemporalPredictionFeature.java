...
public class IMDBTemporalPredictionFeature {
	...
	{	
		...
		String ZmatrixFileName = "IMDB/Zmatrix/Zmatrix_5of5.txt"; // previous Z e.g. for t=3 IMDB/Zmatrix/Zmatrix_2of3.txt
		String labelFileName = "IMDB/5intervals/labels_for_4of5_newMovies_in_5of5.txt";
		String temporalPredictionFileName = "IMDB/5intervals/temporalPredictionFor_5of5.txt";
