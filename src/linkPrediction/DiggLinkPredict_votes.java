...
public class DiggLinkPredict_votes {
	...
	{	
		...
		ArrayList <ArrayList<DiggLinkPredict_votes>> latentSpace = new ArrayList <ArrayList<DiggLinkPredict_votes>>(); 
		String currentLineString, numOfNonZero=null;
		int latentPosIndex=0, nodeIndex = 0, neighborIndex = 0;
		double weight=0.0;

		try{
			BufferedReader br = new BufferedReader(new FileReader("Digg/7intervals_friends/Zmatrix5.txt"));
		...
		try{
			BufferedReader br2 = new BufferedReader(new FileReader("Digg/7intervals_friends/digg_friends_7of7.txt"));
			...
			for(int sourceNodeID = 0; sourceNodeID <142962; sourceNodeID++){ 
