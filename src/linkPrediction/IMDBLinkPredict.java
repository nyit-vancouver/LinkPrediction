...
public class IMDBLinkPredict {
	...
	{	
		...
		try{
			BufferedReader br = new BufferedReader(new FileReader("IMDB/Zmatrix/Zmatrix_7of7.txt"));
		...
		try{
			BufferedReader br2 = new BufferedReader(new FileReader("IMDB/7intervals/user_movie_relation_7of7.txt"));
