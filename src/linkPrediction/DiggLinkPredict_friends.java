...
public class DiggLinkPredict_friends {
	...
	{	
		...
		ArrayList <ArrayList<DiggLinkPredict_friends>> latentSpace = new ArrayList <ArrayList<DiggLinkPredict_friends>>(); 
		String currentLineString, numOfNonZero=null;
		int latentPosIndex=0, nodeIndex = 0, neighborIndex = 0;
		double weight=0.0;

		try{
			BufferedReader br = new BufferedReader(new FileReader("Digg/3intervals_friends/Zmatrix1.txt"));
		...
		try{
			BufferedReader br2 = new BufferedReader(new FileReader("Digg/3intervals_friends/digg_friends_3of3.txt"));
