...
public class DiggTemporalPredictionFeature_votes {

	public static void main(String[] args) 
	{	
		// inputs
		int numberOfNodes = 339778, numOfDimensions = 20;

		double[][] z = new double[numberOfNodes][numOfDimensions];
		ArrayList<ArrayList<Integer>> neighbors = new ArrayList<ArrayList<Integer>>();

		ArrayList <ArrayList<DiggTemporalPredictionFeature_votes>> latentSpace = new ArrayList <ArrayList<DiggTemporalPredictionFeature_votes>>(); 
		String currentLineString, numOfNonZero=null;
		int latentPosIndex=0, nodeIndex = 0, neighborIndex = 0;
		double weight=0.0;

		String ZmatrixFileName = "Digg/3intervals_votes/Zmatrix1.txt"; // previous Z e.g. for t=3 IMDB/Zmatrix/Zmatrix_2of3.txt
		String labelFileName = "Digg/3intervals_votes/labels_for_2of3_newLinks_in_3of3.txt";
		String temporalPredictionFileName = "Digg/3intervals_votes/temporalPredictionFor_3of3.txt";
