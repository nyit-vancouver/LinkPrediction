 ...
 * @user aminmf
 */
public class IMDB_relations_MovieGenre {
	...
	{	 
		...
		String currentLineString, currentLineString1, genre;
		...
		try{
			...
			BufferedReader br1 = new BufferedReader(new FileReader("MovielensIMDB/movie_genres.txt"));
			BufferedWriter bw = new BufferedWriter(new FileWriter(new File("MovielensIMDB/movie_genre_relation.txt")));
			BufferedWriter bw1 = new BufferedWriter(new FileWriter(new File("MovielensIMDB/genres.txt")));
			...
			bw.write("newMovieID\t"+ "genreID\n");
			bw1.write("genreID\t"+ "genre\n");
