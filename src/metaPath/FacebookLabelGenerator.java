 ...
 * @author aminmf
 */
public class FacebookLabelGenerator {
	...
	{	 
		...
		String userMovieAllTimeFileName = "Facebook/facebook_all.txt";
		String userMovieLabelFileName = "Facebook/labels_for_6of7_newLinks_in_7of7.txt";	// this is labels for current time
		String userMovieNextTimeFileName = "Facebook/facebook_7of7.txt";		// this is relations for next time
