 ...
 * @user aminmf
 */
public class IMDB_relations_MovieActor {
	...
	{	 
		...
		String currentLineString, currentLineString1, actor;
		...
		try{
			...
			BufferedReader br1 = new BufferedReader(new FileReader("MovielensIMDB/movie_actors.txt"));
			BufferedWriter bw = new BufferedWriter(new FileWriter(new File("MovielensIMDB/movie_actor_relation.txt")));
			BufferedWriter bw1 = new BufferedWriter(new FileWriter(new File("MovielensIMDB/actors.txt")));
			...
			bw.write("newMovieID\t"+ "actorID\n");
			bw1.write("actorID\t"+ "actor\n");
