...
public class DiggDataSetGenerator_friends {
	...
	{	 
		...
		try{
			...
			BufferedReader lfile = new BufferedReader(new FileReader("Digg/" + intervals + "intervals_friends/labels_for_" + currentInterval + "of7_newLinks_in_" + Integer.toString((Integer.parseInt(currentInterval)+1)) + "of" + intervals + ".txt"));
			BufferedWriter dataset1 = new BufferedWriter(new FileWriter(new File("Digg/" + intervals + "intervals_friends/training1_for_" + currentInterval + "of" + intervals + ".txt"))); // for this interval
