 ...
 * @author aminmf
 */
public class InfectionLabelGenerator {
	...
	{	 
		...
		String userMovieAllTimeFileName = "Infection/infection_links.txt";
		String userMovieLabelFileName = "Infection/labels_for_2of3_newLinks_in_3of3.txt";	// this is labels for current time
		String userMovieNextTimeFileName = "Infection/infection_links_3of3.txt";		// this is relations for next time
