...
public class IMDBResultsEvaluation {
	...
	{	 
		...
		try{
			...
			BufferedReader pred1file = new BufferedReader(new FileReader("IMDB/3intervals/predict1_1999_2001_min5paper.txt"));
			...
			BufferedReader pred2file = new BufferedReader(new FileReader("IMDB/3intervals/predict2_1999_2001_min5paper.txt"));
			...
			BufferedReader pred3file = new BufferedReader(new FileReader("IMDB/3intervals/predict3_1999_2001_min5paper.txt"));
			...
			BufferedReader pred4file = new BufferedReader(new FileReader("IMDB/7intervals/training3_for_1of7.txt"));
