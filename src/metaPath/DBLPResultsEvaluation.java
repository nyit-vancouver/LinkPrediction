...
public class DBLPResultsEvaluation {
	...
	{	 
		...
		try{
			...
			BufferedReader pred1file = new BufferedReader(new FileReader("7IntervalsPrediction/predict1_1999_2001_min5paper.txt"));
			...
			BufferedReader pred2file = new BufferedReader(new FileReader("7IntervalsPrediction/predict2_1999_2001_min5paper.txt"));
			...
			BufferedReader pred3file = new BufferedReader(new FileReader("7IntervalsPrediction/predict3_1999_2001_min5paper.txt"));
			...
			BufferedReader pred4file = new BufferedReader(new FileReader("7IntervalsPrediction/training3_1999_2001_min5paper.txt"));
