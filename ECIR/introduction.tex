...
\item We present a simple yet effective technique, called MetaDynaMix, that leverages topological meta path-based and latent features to predict a target relationship between two nodes in a DHIN;
...
\item We empirically evaluate the efficacy and accuracy of our proposed work on two real-world datasets, and the results show up to X\% improvement compared to the state of the art baselines.
