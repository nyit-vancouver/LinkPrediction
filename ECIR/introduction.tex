...
\amin{I think it's better to present it as a question. "....Given a DHIN graph $G$ at $t$ consecutive time intervals, how can we predict the existence of a particular relationship/path between two given nodes at time $t+1$?"} %The main contributions of our work include:
