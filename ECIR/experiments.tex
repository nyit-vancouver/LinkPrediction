...
Sun et al. \cite{sun2011ASONAM} showed that their proposed \textit{PathPredict} approach is superior to traditional link prediction techniques such as common neighbors, Jaccard?s coefficient, and Katz. Such methods are homogeneous and non-temporal. The number of common neighbors, preferential attachment [2], [9], Jaccard?s coefficient, and Katz [5], are amongst frequently used topological features defined in homogeneous networks.
