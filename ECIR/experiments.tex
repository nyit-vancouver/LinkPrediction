...
\centering
\subfigure{
\includegraphics[trim = 0mm 0mm 0mm 0mm,width=0.31\hsize]{figs/publicationsSchema.pdf}
\includegraphics[trim = 0mm 0mm 0mm 0mm,width=0.31\hsize]{figs/publicationsSchema.pdf}
\includegraphics[trim = 0mm 0mm 0mm 0mm,width=0.31\hsize]{figs/moviesSchema.pdf}
 \label{Fig:DBLP2}
}
\subfigure{
\includegraphics[trim = 0mm 0mm 0mm 0mm,width=0.31\hsize]{figs/moviesSchema.pdf}
...
\label{table_publications}\scriptsize\label{tbl:auc}
\begin{tabular}{|l|c|l|l|l|} \hline
\textbf{Method} & \textbf{Metric} & \textbf{Publications1} & \textbf{Publications2} & \textbf{Movies}\\ \hline

\multirow{2}{*}{PathPredict} & ROC &  & & \\ \cline{2-5}
& PR &  & & \\ \hline

\multirow{2}{*}{PathPredict2} & ROC &  & & \\ \cline{2-5}
& PR &  & & \\ \hline

\multirow{2}{*}{MLP} & ROC &  & & \\ \cline{2-5}
& PR &  & & \\ \hline

\multirow{2}{*}{LRMLP} & ROC &  & & \\ \cline{2-5}
& PR &  & & \\ \hline

\multirow{2}{*}{MetaDynaMix} & ROC &  & & \\ \cline{2-5}
& PR &  & & \\ \hline
