...
To asses link prediction accuracy, we use Area Under Curves (both Receiver Operating Characteristic (ROC) and Precision-Recall (PR) curves), termed as AUCROC and AUCPR \cite{davis2006relationship}. %We also present the prediction accuracy for 5-fold cross validation. 
...
\centering
\subfigure[Publications Network]{
\includegraphics[trim = 0mm 10mm -10mm 0mm,width=0.4\hsize]{figs/Rplot.pdf}
\includegraphics[trim = -10mm 10mm 0mm 0mm,width=0.4\hsize]{figs/Rplot.pdf}
 \label{Fig:DBLP2}
}
\subfigure[Movies Network]{
\includegraphics[trim = 0mm 10mm -10mm 10mm,width=0.4\hsize]{figs/Rplot.pdf}
\includegraphics[trim = -10mm 10mm 0mm 10mm,width=0.4\hsize]{figs/Rplot.pdf}
 \label{Fig:IMDB}
}
